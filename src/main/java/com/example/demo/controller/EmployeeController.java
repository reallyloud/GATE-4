...
public class EmployeeController  {
    ...
    @PostMapping()
    public ResponseEntity<ResponseEmployee> createEmployee(@Valid @RequestBody RequestEmployee requestEmployee) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseEmployee> updateEmployee(@PathVariable UUID id,
                                                           @RequestBody RequestEmployee request) {
